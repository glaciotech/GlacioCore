...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "GlacioCore",
                      url: "https://github.com/glaciotech/GlacioCore/releases/download/pre-alpha-v0.12.1/GlacioCoreFile",
                      checksum: "GlacioCoreSHA"),
        .binaryTarget(name: "MessagePack",
                      url: "https://github.com/glaciotech/GlacioCore/releases/download/pre-alpha-v0.12.1/MessagePackFile",
                      checksum: "MessagePackSHA"),
        .binaryTarget(name: "ArgumentParser",
                      url: "https://github.com/glaciotech/GlacioCore/releases/download/pre-alpha-v0.12.1/ArgumentParserFile",
                      checksum: "ArgumentParserSHA"),
        .binaryTarget(name: "ArgumentParserToolInfo",
                      url: "https://github.com/glaciotech/GlacioCore/releases/download/pre-alpha-v0.12.1/ArgumentParserToolInfoFile",
